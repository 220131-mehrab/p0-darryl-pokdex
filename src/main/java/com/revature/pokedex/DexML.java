    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        try {
            resp.getWriter().println("<html>" +
                    ...
                    "                       <h1><b><u>&nbsp;&nbsp;Welcome to THE Pokédex!&nbsp;&nbsp;</u></b></h1>" +
                    "                       <form name='DexForm' action='pokemon' method='get'>" +
                    "                           <input id='searchBox' type=name name='searchName' value='Search ANY Field!' onclick='ClickedBox()'>" +
                    "                           <input type=submit value='Search Through Pokémon'>" +
                    "                       </form><br><a href='pokemon'>Show Me the Whole List</a><br><br><br>" +
                    "                   </div>" +
